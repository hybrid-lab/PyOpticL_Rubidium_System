...
def example_baseplate(x=0, y=0, angle=0):
    ...
    baseplate.place_element_along_beam("Mirror", optomech.circular_mirror_union_optic, beam,
                                   beam_index=0b1, distance=1.5*layout.inch, angle=layout.turn['down-left'],
                                   mount_type=optomech.mirror_mount_M05X,
                                   mount_args=dict(thumbscrews=True))

    baseplate.place_element_along_beam("Mirror", optomech.circular_mirror_union_optic, beam,
                               beam_index=0b1, distance=3*layout.inch, angle=layout.turn['up-right'],
                               mount_type=optomech.mirror_mount_M05X,
                               mount_args=dict(thumbscrews=True))
    ...
    baseplate.place_element_along_beam("Optical_Isolator", optomech.isolator_780_mp, beam,
                                       beam_index=0b1, distance=3.95*layout.inch, angle=layout.cardinal['left'])
    ...
    baseplate.place_element_along_beam("1/2 Waveplate", optomech.waveplate, beam,
                                       beam_index=0b1, distance=3.9*layout.inch, angle=layout.cardinal['right'],
                                       mount_type=optomech.rotation_stage_rsp05)
    ...
    baseplate.place_element_along_beam("Mirror", optomech.circular_mirror_union_optic, beam,
                                       beam_index=0b101, distance=3.5*layout.inch, angle=layout.turn['down-left'] + aom.DiffractionAngle.Value,
                                       mount_type=optomech.mirror_mount_M05,
                                       mount_args=dict(thumbscrews=True))
    ...
    baseplate.place_element_along_beam("1/2 Waveplate", optomech.waveplate, beam,
                                       beam_index=0b101, distance=1.0*layout.inch, angle=layout.cardinal['left'],
                                       mount_type=optomech.rotation_stage_rsp05)

    baseplate.place_element_along_beam("Iris", optomech.pinhole_ida12, beam,
                                       beam_index=0b100, distance=7.0*layout.inch, angle=layout.cardinal['left'])
